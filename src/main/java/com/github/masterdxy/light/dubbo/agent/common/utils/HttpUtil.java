...
public class HttpUtil {
    ...
    public static String doPost(String apiUrl) {
        return doPostURLEncoding(apiUrl, new HashMap<String, Object>());
    }
     ...
     * @return
     */
    public static String doPostURLEncoding(String apiUrl, Map<String, Object> params) {
    ...
    public static String doPut(String apiUrl, Map<String, Object> params) {
        ...
        try {
            ...
            httpPut.addHeader("Cookie","Hm_lvt_c4578bda90040ec19ded56112b82246f=1477047628,1477275644; Hm_lpvt_c4578bda90040ec19ded56112b82246f=1477413693; JSESSIONID=6337B898E3324D0000A44F3B7498D16F");
